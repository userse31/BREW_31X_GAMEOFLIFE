...
# indicate a module must be built and named gameoflife.dll
BUILD_BREWMODS = gameoflife

# specifies all the C source files that need to be compiled
gameoflife_C_SRCS = AEEAppGen \
	AEEModGen

# specifies all the C++ source files that need to be compiled
gameoflife_CPP_SRCS = gameoflife

# specifies the cif files to be compiled
gameoflife_CIFS = gameoflife
...
gameoflife_C_SRCS +=glibc_stubs
endif

ifneq ($(V_TARGET),Win32)
ifneq ($(V_TARGET),mingw)
gameoflife_C_SRCS +=mod_malloc
endif
endif
...
BREWMP_INPUT = Debug/gameoflife.dll \
	Debug/gameoflife.mif

endif

ifeq ($(V),Win32_Release)
#Win32_Release package settings
BREWMP_INPUT = Release/gameoflife.dll \
	Release/gameoflife.mif

endif

ifneq ($(V_TARGET),Win32)
#Arm package settings
BREWMP_INPUT = $(OBJ_DIR)/gameoflife.mod \
	$(OBJ_DIR)/gameoflife.mif
